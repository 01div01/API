...
public class CreateManagement extends BaseClass
{
	...
	By organiseButton=By.xpath("//*[text()='Manage Organisation']");
	By addOrganisationLink=By.xpath("//*[text()='Add Organisation']");
	...
	{
		Thread.sleep(5000);
		performAction.performClick(clickOnButton);
		Thread.sleep(500);
	
		performAction.performClick(organiseButton);
		Thread.sleep(500);
		performAction.performClick(addOrganisationLink);
	}
	public void clickOnBackButton() throws InterruptedException
	{
		Thread.sleep(500);
		performAction.performClick(backButton);
	}
	public void enterOrganisationName(String name) throws InterruptedException
	{
	...
	public void deleteManagement(String managementName) throws InterruptedException
	{
		driver.findElement(clickOnButton).click();
		Thread.sleep(500);
		driver.findElement(organiseButton).click();
