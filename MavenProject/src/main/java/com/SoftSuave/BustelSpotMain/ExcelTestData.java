...
public class ExcelTestData 
{
	...
	public static String getCellValueAPI(int rownum, int cellnum)
	{
	...
	public static void establishConnection()
	{
		try
		{
		fis =new FileInputStream("C:\\Users\\Softsuave\\Downloads\\BustleHome-master\\BustleHome-master\\BustleSpot\\TestData.xlsx");
